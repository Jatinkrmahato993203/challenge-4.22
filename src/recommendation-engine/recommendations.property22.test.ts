...
describe("Feature: stadium-congestion-forecasting, Property 22: Dropping below Moderate removes prior actions", () => {
  it("returns an empty action list whenever the current risk level is Low", () => {
    fc.assert(
      fc.property(
        gateArb,
        riskLevelAndScoreArb("LOW"),
